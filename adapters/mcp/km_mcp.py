...
def tools() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "description": "Promote an approved Inbox candidate to Wiki. Requires explicit approval metadata.",
            "inputSchema": object_schema({
                "candidate": {"type": "string"},
                "target": {"type": "string"},
                "title": {"type": "string"},
                "summary": {"type": "string"},
                "approved_by": {"type": "string", "default": "user"},
                "scope": {"type": "string", "default": "explicit user approval"},
                "dry_run": {"type": "boolean", "default": False},
            }, required=["candidate"]),
        },
        {
